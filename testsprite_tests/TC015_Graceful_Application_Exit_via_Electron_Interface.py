...
async def run_test():
    ...
    try:
        ...
        # Input email and password into the correct fields and click the Sign In button.
        ...
        # Trigger the app exit using the native window close button (index 19) to test graceful shutdown.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div[2]/header/div[3]/div[4]/button[3]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
