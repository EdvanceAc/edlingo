...
async def run_test():
    ...
    try:
        ...
        # Refresh the page to try to resolve the loading issue and access the login page.
        await page.goto('http://127.0.0.1:3002/', timeout=10000)
        

        # Enter invalid credentials and click on Sign In button.
        ...
        assert False, 'Test failed: Authentication failure and access denial could not be verified.'
