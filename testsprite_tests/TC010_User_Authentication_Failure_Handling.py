...
async def run_test():
    ...
    try:
        ...
        # Try to reload the page to see if the login form loads properly.
        await page.goto('http://127.0.0.1:3002/', timeout=10000)
        

        # Input invalid email and password, then click the Sign In button to attempt login.
        ...
        assert False, 'Test failed: Invalid login attempt did not produce expected error message.'
