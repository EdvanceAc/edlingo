...
async def run_test():
    ...
    try:
        ...
        # Try to reload the app page to see if the loading issue resolves.
        await page.goto('http://127.0.0.1:3002/', timeout=10000)
        

        # Input the email and password, then click the Sign In button to test login functionality.
        ...
        # Test core functionalities by navigating to Courses, Chat, and other key features to verify they load and function correctly.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div/nav/div[2]/a').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Click the 'Start' button on the Test English Course card to verify course content loads and user can interact with lessons.
        frame = context.pages[-1]
