...
import { InsightsCharts } from "../live/components/insights-charts/InsightsCharts";
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center gap-2">
                    ...
                    <h2 className="text-base md:text-lg font-semibold text-white">Insights & Charts</h2>
                  </div>
                  <span className="text-xs text-white/70">Generated by assistant</span>
                </div>
                <div className="rounded-xl bg-black/30 ring-1 ring-white/10 overflow-hidden min-h-[240px]">
                  <InsightsCharts />
                </div>
              </motion.div>
